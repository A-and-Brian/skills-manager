...
use app_lib::core::{
    ...
    skill_store::SkillStore, skill_tags, skill_update, skill_update_check, skillssh_api,
    sync_engine, sync_metadata, tool_adapters, tool_service,
};
use clap::{Args, Parser, Subcommand};

use crate::args::{
    GitArgs, PresetArgs, RepoArgs, SkillsArgs, SkillsCommand, TagArgs, TagCommand, ToolsArgs,
};
...
mod tests {
    use super::*;
    use crate::args::{PresetCommand, ToolsCommand};
